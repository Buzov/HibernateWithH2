...
import com.quasar.hibernateh2.dao.entity.Chair;
import com.quasar.hibernateh2.dao.entity.Family;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(
            "Family " + checkEntity.getId() + " with " + checkEntity.getFamilyMembersAmount()
