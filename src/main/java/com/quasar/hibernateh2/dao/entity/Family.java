...
public class Family implements Serializable {
    ...
    private static final long serialVersionUID = -25769252903390843L;
    ...
    public boolean equals(Object o) {
        ...
        if (familyMembersAmount != family.familyMembersAmount) {
            return false;
        }
        if (id != family.id) {
            return false;
        }
        if (chair != null ? !chair.equals(family.chair) : family.chair != null) {
            return false;
        }
